        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-4">
            <div className="inline-block bg-teal-900/40 text-teal-200 rounded-full px-5 py-2 text-sm font-semibold mb-2">
              ...
              Each experience is designed to nurture your mind, ease anxiety,
              and support emotional healing in a peaceful, supportive
              environment.
            </div>
            <p className="text-gray-300 text-base max-w-xl mx-auto mt-2">
              Whether you're seeking relief from stress, depression, or simply
              want to reconnect with yourself, our core retreat experiences
              offer proven pathways to inner peace and transformation.
            </p>
          </div>
          <div className="mb-16">
                ...
                >
                  ...
                  <div className="flex-1 flex flex-col p-6 gap-3">
                    ...
                    <div className="bg-teal-900/30 text-teal-200 rounded-lg px-4 py-2 mb-2 text-sm font-semibold flex items-center gap-2">
                      ...
                      <span>
                        Find peace, support, and transformation. Our retreats
                        are designed for those seeking relief from stress,
                        depression, or anxiety—offering a safe space for healing
                        and renewal through mindfulness, yoga, and compassionate
                        community.
                      </span>
                    </div>
                    {/* Retreat Experiences */}
